...
// I see an attempt to reduce the lines of code in this page, but instead of grouping the code in your current groups,
// you could create a generic item called detailInfo and each key uses an instance of that component
